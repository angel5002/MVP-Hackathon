...
### 10.7 Flujo clínico y sistema (11 de septiembre, madrugada)
- **Médico asignado, psicólogo elegido.** La tarjeta del médico ya no tiene desplegable de "otros médicos"; debajo, una fila explica la asignación automática y por qué no se puede cambiar. La lista de psicólogos se muestra completa y ordenada por el mismo sistema de recomendación; la primera tarjeta lleva el motivo en verde y los horarios aparecen debajo con un fundido, centrando el desplazamiento en ellos.
- **Visor de documentos.** Cabecera con el nombre del documento y botón de cierre redondo; abajo, "Compartir" (tonal) y "Descargar" (primario). Solo se abre desde Documentos y Proceso, con el trámite terminado.
- **Chips** un punto más compactos (26 px, 12 px de fuente) para que las dos etiquetas de un profesional quepan en una línea en 360 px cuando su texto lo permite; si no, saltan de línea sin romper la tarjeta.
- **Barra del sistema.** En Android la barra de navegación se oculta (inmersivo transitorio) y el fondo llega hasta el borde inferior; `--sa-bottom` pasa a 0 y la barra de pestañas se apoya en el borde.
